...
export const providerListingSeed: ProviderListing[] = [
  { id: "matunga-breakfast-trail", name: "Matunga Breakfast Trail", area: "Matunga", category: "Food", status: "Published", availability: "Open", updated: "Today" },
  { id: "vashi-market-loop", name: "Vashi Market Loop", area: "Vashi", category: "Shopping", status: "Published", availability: "Limited", updated: "Yesterday" },
];
